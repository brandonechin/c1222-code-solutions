...
function renderPokemon(pokemon) {
  ...
  headingTwo.appendChild(document.createTextNode(pokemon.name));
  pokemonCardText.appendChild(headingTwo);
  var headingThree = document.createElement('h3');
  headingThree.appendChild(document.createTextNode(pokemon.number));
  pokemonCardText.appendChild(headingThree);
  var paragraph = document.createElement('p');
  paragraph.appendChild(document.createTextNode(pokemon.description));
